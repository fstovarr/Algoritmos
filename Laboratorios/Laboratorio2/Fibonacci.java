public class Fibonacci {
    ...
    public static void ffloat() {
        ...
        System.out.format("Float variable doesn't overflow, but with" +
                " big numbers the precision is lost. For larger values" +
                " than fib(%d), the result is %f\n\n", (i - 1), a);
    }
    ...
    public static void ddouble() {
        ...
        for (i = 0; i <= 1476; i++){
            ...
            //System.out.println("fib(%d) = %f\n",i,a);
            p = a;
        }

        System.out.format("Double variable doesn't overflow, but with big numbers" +
                " the precision is lost. For larger values than fib(%d), the result" +
                " is %f\n\n", (i - 1), a);
    }
